...
public class W_TridentOfTheSeas extends ChargedItem {
    public W_TridentOfTheSeas(
        ...
        super(ChargesImprovedConfig.trident_of_the_seas, ItemKey.TRIDENT_OF_THE_SEAS, ItemID.TRIDENT_OF_THE_SEAS, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
