...
public class W_IbansStaff extends ChargedItem {
    public W_IbansStaff(
        ...
        super(ChargesImprovedConfig.ibans_staff, ItemKey.IBANS_STAFF, ItemID.IBANS_STAFF, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
