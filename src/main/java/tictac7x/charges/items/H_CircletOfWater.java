...
public class H_CircletOfWater extends ChargedItem {
    public H_CircletOfWater(
        ...
        super(ChargesImprovedConfig.circlet_of_water, ItemKey.CIRCLET_OF_WATER, ItemID.CIRCLET_OF_WATER, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
