...
public class U_JarGenerator extends ChargedItem {
    public U_JarGenerator(
        ...
        super(ChargesImprovedConfig.jar_generator, ItemKey.JAR_GENERATOR, ItemID.JAR_GENERATOR, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
