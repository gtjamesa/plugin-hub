...
public class A_CrystalHelm extends ChargedItem {
    public A_CrystalHelm(
        ...
        super(ChargesImprovedConfig.crystal_helm, ItemKey.CRYSTAL_HELM, ItemID.CRYSTAL_HELM, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
