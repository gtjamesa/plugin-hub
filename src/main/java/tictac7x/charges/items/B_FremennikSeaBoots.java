...
public class B_FremennikSeaBoots extends ChargedItem {
    public B_FremennikSeaBoots(
        ...
        super(ChargesImprovedConfig.fremennik_sea_boots, ItemKey.FREMENNIK_SEA_BOOTS, ItemID.FREMENNIK_SEA_BOOTS, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
