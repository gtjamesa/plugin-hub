...
public class DharoksPlatebody extends ChargedItem {
    public DharoksPlatebody(
        ...
        super(ChargesImprovedConfig.barrows_set, ItemID.DHAROKS_PLATEBODY, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
