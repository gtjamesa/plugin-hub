...
public class GuthansChainskirt extends ChargedItem {
    public GuthansChainskirt(
        ...
        super(ChargesImprovedConfig.barrows_set, ItemID.GUTHANS_CHAINSKIRT, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
