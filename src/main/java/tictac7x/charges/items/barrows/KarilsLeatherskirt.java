...
public class KarilsLeatherskirt extends ChargedItem {
    public KarilsLeatherskirt(
        ...
        super(ChargesImprovedConfig.barrows_set, ItemID.KARILS_LEATHERSKIRT, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
