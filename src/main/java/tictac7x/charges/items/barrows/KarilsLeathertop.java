...
public class KarilsLeathertop extends ChargedItem {
    public KarilsLeathertop(
        ...
        super(ChargesImprovedConfig.barrows_set, ItemID.KARILS_LEATHERTOP, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
