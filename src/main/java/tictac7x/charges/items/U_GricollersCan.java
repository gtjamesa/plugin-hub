...
public class U_GricollersCan extends ChargedItem {
    public U_GricollersCan(
        ...
        super(ChargesImprovedConfig.gricollers_can, ItemKey.GRICOLLERS_CAN, ItemID.GRICOLLERS_CAN, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
