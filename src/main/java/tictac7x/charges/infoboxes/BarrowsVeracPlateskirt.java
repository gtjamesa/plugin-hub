...
public class BarrowsVeracPlateskirt extends ChargedItemInfoBox {
    public BarrowsVeracPlateskirt(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final InfoBoxManager infoboxes, final Plugin plugin) {
        super(ItemID.VERACS_PLATESKIRT, client, client_thread, configs, items, infoboxes, plugin);
