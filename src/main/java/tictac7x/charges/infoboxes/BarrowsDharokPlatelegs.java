...
public class BarrowsDharokPlatelegs extends ChargedItemInfoBox {
    public BarrowsDharokPlatelegs(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final InfoBoxManager infoboxes, final Plugin plugin) {
        super(ItemID.DHAROKS_PLATELEGS, client, client_thread, configs, items, infoboxes, plugin);
