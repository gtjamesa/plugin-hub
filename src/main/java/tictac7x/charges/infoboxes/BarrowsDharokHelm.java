...
public class BarrowsDharokHelm extends ChargedItemInfoBox {
    public BarrowsDharokHelm(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final InfoBoxManager infoboxes, final ChargesImprovedConfig config, final Plugin plugin) {
        super(ItemID.DHAROKS_HELM, client, client_thread, configs, items, infoboxes, config, plugin);
