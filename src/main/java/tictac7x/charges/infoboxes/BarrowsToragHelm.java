...
public class BarrowsToragHelm extends ChargedItemInfoBox {
    public BarrowsToragHelm(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final InfoBoxManager infoboxes, final Plugin plugin) {
        super(ItemID.TORAGS_HELM, client, client_thread, configs, items, infoboxes, plugin);
