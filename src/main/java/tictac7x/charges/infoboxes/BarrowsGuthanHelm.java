...
public class BarrowsGuthanHelm extends ChargedItemInfoBox {
    public BarrowsGuthanHelm(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final InfoBoxManager infoboxes, final Plugin plugin) {
        super(ItemID.GUTHANS_HELM, client, client_thread, configs, items, infoboxes, plugin);
