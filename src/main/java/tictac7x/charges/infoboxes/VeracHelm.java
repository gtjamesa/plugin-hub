...
public class VeracHelm extends ChargedItemInfoBox {
    public VeracHelm(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final Plugin plugin) {
