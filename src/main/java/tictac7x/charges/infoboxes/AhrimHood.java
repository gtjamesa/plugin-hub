...
public class AhrimHood extends ChargedItemInfoBox {
    public AhrimHood(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final Plugin plugin) {
