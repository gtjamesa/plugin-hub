...
public class J_BraceletOfFlamtaer extends ChargedItemInfoBox {
    public J_BraceletOfFlamtaer(
        ...
        super(ChargesItem.BRACELET_OF_FLAMTAER, ItemID.FLAMTAER_BRACELET, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, plugin);
