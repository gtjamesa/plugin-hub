...
public class BarrowsToragPlatelegs extends ChargedItemInfoBox {
    public BarrowsToragPlatelegs(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final InfoBoxManager infoboxes, final Plugin plugin) {
        super(ItemID.TORAGS_PLATELEGS, client, client_thread, configs, items, infoboxes, plugin);
