...
public class BarrowsGuthanPlatebody extends ChargedItemInfoBox {
    public BarrowsGuthanPlatebody(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final InfoBoxManager infoboxes, final ChargesImprovedConfig config, final Plugin plugin) {
        super(ItemID.GUTHANS_PLATEBODY, client, client_thread, configs, items, infoboxes, config, plugin);
