...
public class J_BraceletOfSlaughter extends ChargedItemInfoBox {
    public J_BraceletOfSlaughter(
        ...
        super(ChargesItem.BRACELET_OF_SLAUGHTER, ItemID.BRACELET_OF_SLAUGHTER, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, plugin);
