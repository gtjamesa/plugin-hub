...
public class W_PharaohSceptre extends ChargedItemInfoBox {
    public W_PharaohSceptre(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final InfoBoxManager infoboxes, final ChargesImprovedConfig config, final Plugin plugin) {
        super(ItemID.PHARAOHS_SCEPTRE, client, client_thread, configs, items, infoboxes, config, plugin);
