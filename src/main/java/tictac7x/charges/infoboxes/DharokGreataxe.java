...
public class DharokGreataxe extends ChargedItemInfoBox {
    public DharokGreataxe(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final Plugin plugin) {
