...
public class J_RingOfSuffering extends ChargedItemInfoBox {
    public J_RingOfSuffering(
        ...
        super(ChargesItem.RING_OF_SUFFERING, ItemID.RING_OF_SUFFERING, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, storage, plugin);
