...
public class W_SkullSceptre extends ChargedItemInfoBox {
    public W_SkullSceptre(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final Plugin plugin) {
        super(ItemID.SKULL_SCEPTRE, client, client_thread, configs, items, plugin);
