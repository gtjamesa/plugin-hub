...
public class S_KharedstMemoirs extends ChargedItemInfoBox {
    public S_KharedstMemoirs(
        ...
        super(ChargesItem.KHAREDSTS_MEMOIRS, ItemID.KHAREDSTS_MEMOIRS, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, storage, plugin);
