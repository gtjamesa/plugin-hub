...
public class BarrowsDharoksGreataxe extends ChargedItemInfoBox {
    public BarrowsDharoksGreataxe(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final InfoBoxManager infoboxes, final ChatMessageManager chat_messages, final ChargesImprovedConfig config, final Plugin plugin) {
