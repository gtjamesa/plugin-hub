...
public class GuthanChainskirt extends ChargedItemInfoBox {
    public GuthanChainskirt(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final Plugin plugin) {
