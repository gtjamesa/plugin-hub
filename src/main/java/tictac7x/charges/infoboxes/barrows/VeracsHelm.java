...
public class VeracsHelm extends ChargedItemInfoBox {
    public VeracsHelm(
        final Client client,
        ...
        super(ChargesItem.BARROWS_GEAR, ItemID.VERACS_HELM, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, plugin);
