...
public class AhrimsRobetop extends ChargedItemInfoBox {
    public AhrimsRobetop(
        ...
        super(ChargesItem.BARROWS_GEAR, ItemID.AHRIMS_ROBETOP, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, plugin);
