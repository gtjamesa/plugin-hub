...
public class J_BraceletOfExpeditious extends ChargedItemInfoBox {
    public J_BraceletOfExpeditious(
        ...
        super(ChargesItem.BRACELET_OF_EXPEDITIOUS, ItemID.EXPEDITIOUS_BRACELET, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, plugin);
