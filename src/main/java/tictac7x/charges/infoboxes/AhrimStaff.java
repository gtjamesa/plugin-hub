...
public class AhrimStaff extends ChargedItemInfoBox {
    public AhrimStaff(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final Plugin plugin) {
