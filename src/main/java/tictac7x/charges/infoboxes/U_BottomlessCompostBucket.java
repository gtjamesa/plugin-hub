...
public class U_BottomlessCompostBucket extends ChargedItemInfoBox {
    ...
    public U_BottomlessCompostBucket(
        ...
        super(ChargesItem.BOTTOMLESS_COMPOST_BUCKET, ItemID.BOTTOMLESS_COMPOST_BUCKET_22997, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, storage, plugin);
