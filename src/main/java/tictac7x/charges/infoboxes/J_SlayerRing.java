...
public class J_SlayerRing extends ChargedItemInfoBox {
    public J_SlayerRing(final Client client, final ClientThread client_thread, final ConfigManager configs, final ItemManager items, final InfoBoxManager infoboxes, final ChatMessageManager chat_messages, final ChargesImprovedConfig config, final Plugin plugin) {
        super(ItemID.SLAYER_RING_8, client, client_thread, configs, items, infoboxes, chat_messages, config, plugin);
