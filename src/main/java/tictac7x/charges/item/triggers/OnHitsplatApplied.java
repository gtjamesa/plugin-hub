...
public class OnHitsplatApplied extends TriggerBase {
    ...
    public Optional<WeaponStyle> weaponStyle = Optional.empty();
    ...
    public TriggerBase weaponStyle(final WeaponStyle weaponStyle) {
        this.weaponStyle = Optional.of(weaponStyle);
        return this;
    }
}
